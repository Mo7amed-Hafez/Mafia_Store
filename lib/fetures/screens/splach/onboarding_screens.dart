...
class _OnboardingPageState extends State<OnboardingPage>
    ...
    return Scaffold(
      ...
      body: OverBoard(
        ...
        finishCallback: () async {
          ...
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              content: Text("Welcome to Mafia Store!",
                  style: TextStyle(color: AppColore.primaryColor)),
            ));
            // الانتقال لتسجيل الدخول
  ...
  final pages = [
    ...
    PageModel(
        ...
        body:
            'Browse thousands of products anytime, anywhere, and enjoy a seamless shopping experience from your mobile.',
        doAnimateImage: true),
    PageModel(
        ...
        title: 'Products',
        body:
            'Discover a wide variety of high-quality products carefully selected to meet your needs and style',
        doAnimateImage: true),
    PageModel.withChild(
      child: Padding(
